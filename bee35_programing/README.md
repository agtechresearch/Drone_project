...
### CIGR 2026 포스터 본 실험 (6월)

임계값을 cm 기준으로 바꾼 v14~v17 시리즈와 PID 정렬 vs LOITER 단독 대조 실험 기록은
[`cigr2026/`](cigr2026/) 참조 (비행 코드·로그 CSV·분석 report·포스터 그림).
