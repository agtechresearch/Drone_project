...
실행 순서:
  ...
  터미널3: python flight_apriltag.py
"""
...
# PID 게인
# Roll — 정밀
KP_ROLL  = 0.2   # 낮게, 과보정 방지
KI_ROLL  = 0.005  # 최소한으로
KD_ROLL  = 0.10   # 높게, 미세 진동 억제

# Pitch — 오차 줄이기
KP_PITCH = 0.20   # 높게, 빠른 접근
KI_PITCH = 0.01   # 잔류 오차 보완
KD_PITCH = 0.1   # 낮게, 응답 빠르게
...
def init_logs():
    ...
    rt_path = f"logs/alighn_l_realtime_{ts}.csv"
    ...
    sum_path = f"logs/alighn_l_summary_{ts}.csv"
            ...
            while True:
                ...
                if aligned and not was_aligned:
                    ...
                    if first_align_time is None:
                        ...
                        print(f"[TIMER] 첫 정렬 감지 — {RECORD_DURATION:.0f}초 후 착륙")
